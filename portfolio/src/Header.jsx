  ...
  return (
   <header className="header bx-border-bottom">
    ...
    <ul className="nav">
      ...
      <li className='li' onClick={()=>{display()}} >coding profile <i className='bx uil-arrow-down'></i> 
        <ul className='bx-border-up-none nested-ul-1'>
          <li><a href='https://leetcode.com/mandliyarajendra11/' target='_blank' rel='noreferrer'>leetcode</a></li>
